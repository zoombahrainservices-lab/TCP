      ...
      <header className="bg-blue-800 text-white shadow-lg">
        <div className="container max-w-6xl mx-auto px-4 py-3 md:py-4">
          <div className="flex justify-between items-center">
            <Link href="/parent" className="flex items-center gap-2 md:gap-3 hover:opacity-90 transition-opacity">
              <div className="text-2xl md:text-3xl">📖</div>
              <div>
                <h1 className="text-base md:text-lg font-bold leading-tight">The Communication Protocol</h1>
                <p className="text-xs md:text-sm text-blue-200">Parent Portal</p>
              </div>
            </Link>
