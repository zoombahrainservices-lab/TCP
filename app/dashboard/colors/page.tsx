...
export default function BrandingPage() {
  ...
  return (
    <div className="p-8 lg:p-16 max-w-[1440px] mx-auto pb-20">
      {/* Page Header - Golden Ratio: 1.618 */}
      <div className="mb-16">
        <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight">
          Brand Colors
        </h1>
        <p className="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl leading-relaxed">
          TCP's color system is designed to support behavior change through meaning and emotion. Each color carries specific psychological weight and purpose.
        </p>
      </div>
