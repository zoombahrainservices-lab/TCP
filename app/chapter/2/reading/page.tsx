...
const CHAPTER_2_PDF_PATH =
  "/chapter/Chapter 2_ The Genius Who Couldn't Speak - Printable.pdf"

export default function Chapter2ReadingPage() {
  return (
