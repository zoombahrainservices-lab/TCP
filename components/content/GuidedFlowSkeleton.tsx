...
/**
 * Shared shell skeleton for guided-book flow transitions.
 * Matches ReadingLayout structure for instant perceived navigation.
 */
export default function GuidedFlowSkeleton() {
  return (
