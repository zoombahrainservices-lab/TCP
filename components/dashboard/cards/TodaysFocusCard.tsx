    ...
    <Card className="relative overflow-hidden">
      ...
      <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 p-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-slate-800">Today&apos;s Focus</h2>
            <div className="mt-1 flex items-center gap-2 text-slate-500">
              <span className="font-semibold text-slate-700">Chapter {chapterNumber}</span>
        ...
        <div className="flex flex-col items-start sm:items-end gap-2 shrink-0">
          ...
          <div className="text-sm font-bold text-slate-500">+ {xpAward} XP</div>
        </div>
      </div>
    </Card>
  )
