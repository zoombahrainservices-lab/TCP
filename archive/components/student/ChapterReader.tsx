    ...
    try {
      ...
      if (saved) {
        ...
        if (!isNaN(savedIndex) && savedIndex >= 0 && savedIndex < chunksLength) {
          ...
          // Skip cover page when resuming from saved progress
          if (hasCover && savedIndex > 0) {
    ...
    return (
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white shadow-lg flex flex-col md:flex-row">
          ...
          <div className="p-4 md:p-0 md:w-2/5 bg-gray-50 md:overflow-hidden">
            {currentChunk.imageUrl ? (
              ...
              <div className="w-full h-full bg-gray-200 flex flex-col items-center justify-center text-gray-400 min-h-[300px] md:min-h-[400px] rounded-lg md:rounded-none">
          ...
          <div className="px-4 pb-6 md:w-3/5 md:p-8 flex flex-col">
